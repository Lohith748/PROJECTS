...
class categoryClass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="C",command=self.clear,font=("times new roman",15),bg="GRAY",cursor="hand2").place(x=540,y=95,width=20,height=30)
        ###===category details
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="": 
                    messagebox.showerror("STOP!","CID is required",parent=self.root)
            else:
